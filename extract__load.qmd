...
```{r}
# Assuming 'countries' is your data frame and it has columns 'entity' for country and 'ymd' for date
...
life_expectancy_data <- countries %>%
  ...
  mutate(time_point = ifelse(time_point == "first_life_expectancy", "First", "Last")) |> head(10)
